...
export class WidgetSystem extends React.Component {
    constructor(props) {
        super(props);
        ...
        widgetstruct.push(new Structs.NewWidgetStructure("OnOff", "Label1", "route"));
        widgetstruct.push(new Structs.NewWidgetStructure("TestLabel", "Label2", "route"));
        widgetstruct.push(new Structs.NewWidgetStructure("TestForm", "Label1", "route"));
        widgetstruct.push(new Structs.NewWidgetStructure("TestLabel", "Label3", "route"));
        widgetstruct.push(new Structs.NewWidgetStructure("TestSelfLabel", "Label4", "route"));
        widgetstruct.push(new Structs.NewWidgetStructure("TestSelfLabel", "Label5", "route"));
        // TEST CODE : END
        this.state = {
    ...
    render() {
        return (React.createElement("div", { className: "widget-system" },
            React.createElement("div", { className: "grid-container" },
                React.createElement(Suspense, { fallback: "" },
                    React.createElement(ErrorBoundary, null, this.state.DynamicWidgetComponents.map((struct) => {
                        const DynamicComponent = React.lazy(() => import('./dynamic-components/Widget' + struct.getPair("type")));
                        return (React.createElement("div", { className: "card border-light mb-5" },
                            React.createElement("div", { className: "card-title text-right" },
                                React.createElement("button", { className: "btn", onClick: this.handleSettingsClick(struct) },
                            ...
                            React.createElement("div", { className: "card-body" },
                                React.createElement(DynamicComponent, { structure: struct, updateDynamicComponents: this.updateDynamicComponents, getDynamicComponents: this.getDynamicComponents })),
                            React.createElement("div", { className: "card-footer text-center" },
                                React.createElement("h5", null, struct.getPair("label")))));
                    }))))));
    }
}
//# sourceMappingURL=WidgetSystem.js.map